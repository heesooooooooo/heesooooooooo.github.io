...
nowDoc이 항상 맨 앞을 가리키지는 않는다. nowDoc이 중요도가 제일 크다면 값이 뒤로 밀리지 않기 때문이다. 이와 같은 경우인
<span style="color:#9B9B06">
| <center>priorities</center> | <center>location</center> | <center>return</center> |
|:--------|:--------:|--------:|
| <center>[3,3,4,2]</center> | <center>3</center> | <center>4</center> |
| <center>[1,2,3,0]</center> | <center>0</center> | <center>3</center> |
</span>
테스트 케이스를 적용한다.
